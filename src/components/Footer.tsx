...
import { Phone, Mail, MapPin, Facebook, Twitter, Instagram, Linkedin, ArrowRight, Clock, ShieldCheck } from 'lucide-react';
    ...
    <footer className="bg-secondary text-white relative overflow-hidden dot-matrix">
      ...
      <div className="max-w-7xl mx-auto px-6 pt-8 pb-4 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 mb-4">
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <div className="flex flex-col">
                <span className="font-display font-bold text-lg leading-tight tracking-tight">Dr. Sayantan Gayen</span>
            ...
            <p className="text-white/40 text-sm leading-relaxed max-w-md font-light">
              Providing compassionate, expert care in internal medicine and specialized diabetes management for over a decade in Kolkata.
            </p>
          ...
          >
            <h4 className="font-display font-bold text-[8px] uppercase tracking-[0.3em] mb-3 text-white/20">Navigation</h4>
            <ul className="space-y-2">
              {[
                ...
                <li key={i}>
                  <Link to={link.path} className="text-white/40 hover:text-primary transition-all duration-500 flex items-center gap-2 group text-xs font-light">
          ...
          >
            <h4 className="font-display font-bold text-[8px] uppercase tracking-[0.3em] mb-3 text-white/20">Contact Info</h4>
            <div className="space-y-3">
              <div className="flex gap-2 group">
                ...
                <p className="text-white/40 leading-relaxed text-xs font-light">
                  Manmohan Park, 41/5 Raja Rammohan Roy Rd, Behala Chowrasta, Kolkata 700008
                </p>
              </div>
              <div className="flex gap-2 group">
                <div className="w-7 h-7 rounded bg-white/5 border border-white/5 flex items-center justify-center shrink-0 group-hover:bg-primary/20 transition-all duration-500">
                ...
                <div className="flex flex-col">
                  <span className="text-white/60 text-sm font-bold">079801 65256</span>
                  <span className="text-[6px] text-white/20 uppercase font-bold tracking-[0.3em] mt-0">Available 10AM - 8PM</span>
                </div>
              </div>
            </div>
          </motion.div>
