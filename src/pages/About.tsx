      ...
      <section className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center mb-24 sm:mb-32">
          <motion.div
            ...
            className="relative"
          >
            <div className="rounded-[2.5rem] sm:rounded-[4rem] overflow-hidden shadow-[0_48px_96px_-16px_rgba(0,0,0,0.15)] border-[8px] sm:border-[12px] border-white bg-white relative z-10">
              <img
            ...
            <motion.div
              ...
              className="absolute -bottom-6 -right-6 sm:-bottom-10 sm:-right-10 bg-secondary text-white p-6 sm:p-10 rounded-[1.5rem] sm:rounded-[2.5rem] shadow-2xl z-20"
            >
              <div className="text-3xl sm:text-5xl font-display font-bold text-accent">10+</div>
              <div className="text-[8px] sm:text-[10px] uppercase tracking-[0.3em] font-bold opacity-50 mt-1 sm:mt-2">Years of Excellence</div>
            </motion.div>
