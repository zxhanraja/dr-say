      ...
      <section className="max-w-7xl mx-auto px-6">
          ...
          {services.map((service, index) => (
            ...
            >
              <div className="lg:w-1/2">
                ...
                <div className="space-y-4 sm:space-y-8 text-lg sm:text-xl text-secondary/50 leading-relaxed mb-8 sm:mb-14 font-light">
              ...
              <div className="lg:w-1/2 w-full relative">
                <div className="aspect-[4/5] lg:aspect-[4/3] rounded-[2.5rem] sm:rounded-[5rem] overflow-hidden shadow-[0_64px_128px_-24px_rgba(0,0,0,0.18)] border-[8px] sm:border-[16px] border-white bg-white relative z-10 group">
                  <img
                    src={`https://images.unsplash.com/photo-1576091160550-2173dba999ef?auto=format&fit=crop&q=80&w=800&seed=${index + 10}`}
                    alt={service.title}
                  ...
                  <div className="absolute bottom-6 left-6 right-6 sm:bottom-10 sm:left-10 sm:right-10 glass-card p-6 sm:p-8 rounded-[1.5rem] sm:rounded-[2.5rem] translate-y-20 group-hover:translate-y-0 transition-transform duration-700 opacity-0 group-hover:opacity-100">
                    ...
                    <div className="text-xl sm:text-4xl font-display font-bold text-secondary">98% Positive Outcomes</div>
                  </div>
                </div>
        ...
        >
          ...
          <div className="relative z-10 max-w-3xl mx-auto">
            ...
            <p className="text-lg sm:text-2xl text-white/60 mb-10 sm:mb-16 font-light leading-relaxed">
